...
import com.example.creditmodule.exception.GenericErrorCode;
import com.example.creditmodule.exception.GenericException;
...
public class CustomerService {
    ...
    public CustomerResponse getCustomer(UUID customerId) {
        CustomerEntity customerEntity = customerRepository
                .findById(customerId)
                .orElseThrow(() -> new GenericException(GenericErrorCode.NOT_FOUND));
        return customerMapper.toCustomerResponse(customerEntity);
    }

    public CustomerResponse getCustomerUser(UUID customerId) {
        return null;
    }
}
